...
The overlay is a full-size `ComposeView` added on top of each resumed activity's content. It only
draws, so touches reach the screen underneath, and it is hidden from accessibility services and
