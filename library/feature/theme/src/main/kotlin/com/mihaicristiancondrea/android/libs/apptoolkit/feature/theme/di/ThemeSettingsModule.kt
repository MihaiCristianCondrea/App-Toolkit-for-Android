...
val themeSettingsModule: Module = module {
    ...
    single<ColorPalette>(named(AppToolkitDiConstants.ANDROID_THEME_PALETTE)) { androidPalette }
    ...
    single<ColorPalette>(named(AppToolkitDiConstants.ORANGE_THEME_PALETTE)) { orangePalette }
    ...
    single<ColorPalette>(named(AppToolkitDiConstants.HALLOWEEN_THEME_PALETTE)) { halloweenPalette }
