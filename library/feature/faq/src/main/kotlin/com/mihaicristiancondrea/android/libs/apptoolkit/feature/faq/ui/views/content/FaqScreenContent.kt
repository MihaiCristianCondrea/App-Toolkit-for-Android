...
package com.mihaicristiancondrea.android.libs.apptoolkit.feature.faq.ui.views.content
            ...
            item(key = "show_more_questions") {
                AnimatedVisibility(
                    ...
                    Card(
                        ...
                        onClick = {
                            firebaseController.logGa4Event(
                                faqPreferenceTapEvent(preferenceKey = "show_more_questions")
                            )
            ...
            ContactUsCard(
                ...
                onClick = {
                    firebaseController.logEvent(
                        faqPreferenceTapEvent(preferenceKey = "contact_us").toAnalyticsEvent()
                    )
