...
sealed interface FaqAction : ActionEvent {
    data class OpenUrl(val url: String) : FaqAction
    data object OpenPlayStoreReview : FaqAction
    data class ReviewOutcomeReported(val outcome: ReviewOutcome) : FaqAction
}
