...
import com.mihaicristiancondrea.android.libs.apptoolkit.core.ui.views.ads.rememberAdsAllowed
...
fun HelpScreenContent(
    ...
    val hasAdSlot = rememberAdsAllowed() && adsConfig.bannerAdUnitId.isNotBlank()
