...
fun AdBanner(
    ...
    val adsAllowed: Boolean = rememberAdsAllowed()
    ...
    LaunchedEffect(adView, adsAllowed, adsConfig.bannerAdUnitId, adsConfig.adSize) {
        if (!adsAllowed || adView == null) {
            isAdLoaded = false
    ...
    AnimatedVisibility(
        visible = adsAllowed && isAdLoaded && adView != null,
