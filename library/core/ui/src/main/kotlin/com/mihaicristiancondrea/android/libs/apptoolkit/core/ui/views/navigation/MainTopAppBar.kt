 ...
 * The "Support Us" overflow item is rendered only when the host supplies [onSupportClick], so this
 * module stays free of any dependency on a support feature. Hosts can disable that action entirely
 * and provide their destination's own actions instead. The navigation icon's action is
 * configurable.
 *
 ...
 * is null, so hosts without a support surface get no dead menu entry.
