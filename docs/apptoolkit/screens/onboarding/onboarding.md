...
The **Onboarding** feature provides a reusable, Compose-first onboarding flow that host apps can
plug
in to handle:
...
* `docs/apptoolkit/screens/onboarding/onboarding.md` (how to launch, state/events/actions,
  completion flow)
