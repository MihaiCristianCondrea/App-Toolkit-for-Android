...
- **Generate and analyze** : You MUST run the shell commands described
...
- **Report** : Rely entirely on the generated file `analysis.txt` for scores and rule impact
  metrics. Proceed to Step 3.
