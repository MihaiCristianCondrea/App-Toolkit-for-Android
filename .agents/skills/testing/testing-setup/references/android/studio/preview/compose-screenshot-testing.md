...
Use the `testing-setup` [Android skill](https://developer.android.com/tools/agents/android-skills)
to develop a testing strategy and create screenshot tests. To install the skill from
...
Try [Android CLI](https://developer.android.com/tools/agents) if you're not using Android Studio or
prefer to do things from the command line.

For example, use the [
`android studio render-compose-preview`](https://developer.android.com/tools/agents/android-cli#studio-render-compose-preview)
command when you need to render a Compose preview for visual testing.
