...
include(":library:feature:changelog")
include(":library:feature:faq")
include(":library:feature:issuereporter")
include(":library:feature:licenses")
include(":library:feature:onboarding")
include(":library:feature:permissions")
include(":library:feature:privacy")
include(":library:feature:settings")
include(":library:feature:advanced")
include(":library:feature:diagnostics")
include(":library:feature:display")
include(":library:feature:theme")
