...
/**
 * Checks that this module answers every settings extension point the toolkit asks a host about.
 *
...
class SettingsModuleTest {
    ...
    private fun koin(): Koin {
        ...
        return koinApplication {
            ...
            modules(settingsModule(hostBuildConfig = hostBuildConfig))
        }.koin
    }

    /**
     * The toolkit settings interfaces the sample has to answer.
     *
     ...
     */
    @Test
    fun `resolves every toolkit settings extension point`() {
        // Resolving `AboutSettingsProvider` is also what covers the build-config change: it takes
